...
Quand vous voudrez savoir ce qui a déjà été **essayé chez l'auteur** plutôt que
déduit de l'architecture, lisez [Validation réelle](VALIDATION-REELLE-MORFSYSTEM.md).
